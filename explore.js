...
function lnav() {
    ...
    if (expanded) {
        ...
        document.getElementById("artistscrolldiv").classList.replace("w-[1040px]", "w-[1216px]");
        ...
        document.getElementById("artistscrolldiv").classList.replace("w-[1216px]", "w-[1040px]");
...
function horizontalscroll(left) {
    if (left) {
        document.getElementById("artistscrolldiv").scrollLeft -= 200;
    } else {
        document.getElementById("artistscrolldiv").scrollLeft += 200;
    }
